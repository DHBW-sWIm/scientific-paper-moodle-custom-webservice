...
$plugin->version  = 2020073012;   // The (date) version of this module + 2 extra digital for daily versions
...
$plugin->component = 'local_spsupman';
$plugin->cron     = 0;
$plugin->release = '1.1 (Build: 2020021002)';
